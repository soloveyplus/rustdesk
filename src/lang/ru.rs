...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Подключение к сети Химмед..."),
        ...
        ("install_tip", "Данная программа работает только в сети ХИММЕД. Нажмите кнопку ниже для установки RustDesk в системе."),
